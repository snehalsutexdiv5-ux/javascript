const users = [
    ...
    },
    {
        id: 7,
        name: "Arjuna Rao",
        pic: "https://img.freepik.com/free-photo/portrait-businesswoman-isolated-home_23-2148813223.jpg?semt=ais_user_personalization&w=740&q=80",
    ...
    },
    {
        id: 20,
        name: "Kavya Reddy",
        pic: "https://www.shutterstock.com/image-photo/happy-middle-aged-business-woman-600nw-2454482079.jpg",
...
function showUser(arr) {
    arr.forEach((users) => {
        ...
        img.setAttribute("src", users.pic);
...
bar.addEventListener("input", () => {
    ...
    let new_user = users.filter((users) => {
        return users.name.startsWith(bar.value); // data mate true ave te data save thase
    });
